define([], function () {
  return function(participants) {
    ...
    if(participants.length == 1) {
      pairs = [{purchaser: participants[0], recipient: participants[0]}];
      return pairs;
    }
    ...
    participants.forEach( function(participant) {
        ...
        pairs.push({purchaser: participant, recipient: recipient});
        potentialRecipients = potentialRecipients.filter(function (p) { return p !== recipient; });
      }
    );
