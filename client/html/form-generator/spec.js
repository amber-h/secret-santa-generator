  ...
  describe("An input template", function() {
    ...
    describe("form inputs", function() {
      it("has input elements based on input format", function() {
        ...
        expect(firstInputElement.getAttribute("type")).toEqual("text");
        ...
        expect(secondInputElement.getAttribute("type")).toEqual("email");
      ...
      it("has a button to remove participants when there is more than 1 participant", function() {
        setFixtures('<div class="form-group"><input placeholder="Some Input"></div>' + '<div class="form-group"><input placeholder="Some Other Input"></div>');
